(function () {
	...
	onImagesLoaded(document.getElementById("b_531376"), function() {
		var elements = document.getElementById("b_531376").getElementsByClassName('js-bnfy');
		...
		function startAnimation() {
			...
			gsap.to("#el_I5313765222226", { autoAlpha: 1, x: 0, y: 0, scaleX: 1.2, scaleY: 1.2, rotation: 0, duration: 0, delay: 0 });
			gsap.to("#el_I5313765222226", {
				duration: 7,
				delay: 0,
				repeat: 0,
			...
			gsap.to("#el_I5313765164068", { autoAlpha: 0, x: 0, y: 0, scaleX: 1, scaleY: 1, rotation: 0, duration: 0, delay: 0 });
			gsap.to("#el_I5313765164068", {
				duration: 1,
				delay: 0,
				repeat: 0,
			...
			gsap.to("#el_I53137651140065114002", { autoAlpha: 0, x: 0, y: 0, scaleX: 0, scaleY: 1, rotation: 0, duration: 0, delay: 0 });
			gsap.to("#el_I53137651140065114002", {
				duration: 0.7,
				delay: 0.3,
				repeat: 0,
			...
			gsap.to("#el_I531376511400651139995112213", { autoAlpha: 0, x: 0, y: 50, scaleX: 1, scaleY: 1, rotation: 0, duration: 0, delay: 0 });
			gsap.to("#el_I531376511400651139995112213", {
				duration: 1.2,
				delay: 1,
				repeat: 0,
			...
			gsap.to("#el_I531376511400651139995112214", { autoAlpha: 0, x: 0, y: 0, scaleX: 1, scaleY: 1, rotation: 0, duration: 0, delay: 0 });
			gsap.to("#el_I531376511400651139995112214", {
				duration: 1.6,
				delay: 2,
				repeat: 0,
			...
			gsap.to("#el_I5313765222171", { autoAlpha: 1, x: 0, y: 0, scaleX: 1, scaleY: 1, rotation: 0, duration: 0, delay: 0 });
			gsap.to("#el_I5313765222171", {
				duration: 1,
				delay: 0,
				repeat: 0,
			...
			gsap.to("#el_I5313765222204", { autoAlpha: 0, x: 0, y: 0, scaleX: 1, scaleY: 0, rotation: 0, duration: 0, delay: 0 });
			gsap.to("#el_I5313765222204", {
				duration: 1.5,
				delay: 3.1,
				repeat: 0,
