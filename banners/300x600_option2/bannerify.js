(function () {
	...
	onImagesLoaded(document.getElementById("b_531400"), function() {
		var elements = document.getElementById("b_531400").getElementsByClassName('js-bnfy');
		...
		function startAnimation() {
			...
			gsap.to("#el_I5314005222231", { autoAlpha: 1, x: 0, y: 0, scaleX: 1.2, scaleY: 1.2, rotation: 0, duration: 0, delay: 0 });
			gsap.to("#el_I5314005222231", {
				duration: 7,
				delay: 0,
				repeat: 0,
			...
			gsap.to("#el_I5314005192089", { autoAlpha: 0, x: 0, y: 0, scaleX: 1, scaleY: 1, rotation: 0, duration: 0, delay: 0 });
			gsap.to("#el_I5314005192089", {
				duration: 1,
				delay: 0,
				repeat: 0,
			...
			gsap.to("#el_I53140051920915114002", { autoAlpha: 0, x: 0, y: 0, scaleX: 0, scaleY: 1, rotation: 0, duration: 0, delay: 0 });
			gsap.to("#el_I53140051920915114002", {
				duration: 0.7,
				delay: 0.3,
				repeat: 0,
			...
			gsap.to("#el_I531400519209151139995112213", { autoAlpha: 0, x: 0, y: 50, scaleX: 1, scaleY: 1, rotation: 0, duration: 0, delay: 0 });
			gsap.to("#el_I531400519209151139995112213", {
				duration: 1.2,
				delay: 1,
				repeat: 0,
			...
			gsap.to("#el_I531400519209151139995112214", { autoAlpha: 0, x: 0, y: 0, scaleX: 1, scaleY: 1, rotation: 0, duration: 0, delay: 0 });
			gsap.to("#el_I531400519209151139995112214", {
				duration: 1.6,
				delay: 2,
				repeat: 0,
			...
			gsap.to("#el_I5314005222178", { autoAlpha: 1, x: 0, y: 0, scaleX: 1, scaleY: 1, rotation: 0, duration: 0, delay: 0 });
			gsap.to("#el_I5314005222178", {
				duration: 1,
				delay: 0,
				repeat: 0,
			...
			gsap.to("#el_I5314005222206", { autoAlpha: 0, x: 0, y: 0, scaleX: 1, scaleY: 0, rotation: 0, duration: 0, delay: 0 });
			gsap.to("#el_I5314005222206", {
				duration: 1.5,
				delay: 3.1,
				repeat: 0,
